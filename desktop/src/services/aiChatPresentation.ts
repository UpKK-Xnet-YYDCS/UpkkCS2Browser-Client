...
export const localStatuses = {
  ...
  'zh-CN': { measuring: '正在测试本地 A2S 延迟...', failed: '本地延迟测试失败', resolving: '正在验证服务器...', joining: '正在打开 Steam 加入服务器...', confirmJoin: '请在确认对话框中选择加入方式。', chooseServer: '匹配到多个服务器，请从候选列表中选择一个。', unresolved: '无法唯一确定服务器，请使用完整名称或地址。', unavailable: '本机 A2S 验证失败，不能加入该地址：%s' },
  'zh-TW': { measuring: '正在測試本機 A2S 延遲...', failed: '本機延遲測試失敗', resolving: '正在驗證伺服器...', joining: '正在開啟 Steam 加入伺服器...', confirmJoin: '請在確認對話框中選擇加入方式。', chooseServer: '匹配到多個伺服器，請從候選清單中選擇一個。', unresolved: '無法唯一確定伺服器，請使用完整名稱或位址。', unavailable: '本機 A2S 驗證失敗，不能加入該位址：%s' },
  ko: { measuring: '로컬 A2S 지연 측정 중...', failed: '로컬 지연 테스트 실패', resolving: '서버 확인 중...', joining: 'Steam을 열어 서버에 참가하는 중...', confirmJoin: '확인 대화상자에서 접속 방법을 선택하세요.', chooseServer: '여러 서버가 일치합니다. 후보 목록에서 하나를 선택하세요.', unresolved: '서버를 하나로 식별할 수 없습니다. 전체 이름이나 주소를 입력하세요.', unavailable: '로컬 A2S 확인에 실패하여 이 주소에 접속할 수 없습니다: %s' },
} as const;
